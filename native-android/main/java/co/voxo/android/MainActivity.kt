...
class MainActivity : ReactActivity() {
  ...
  /**
   * Wrap with Expo's [ReactActivityDelegateWrapper] so module lifecycle listeners run on cold
   * start (required by expo-share-intent to stash ACTION_SEND into ExpoShareIntentSingleton).
   * Inner [getLaunchOptions] still supplies CallKeep answer-from-kill props via reflection.
   */
